...
base_model = tf.keras.applications.VGG16(input_shape=(224,224,3),include_top=False,weights='imagenet',pooling='avg')
...
history = model.fit(train_ds,epochs=initial_epochs,validation_data=val_ds,callbacks=[model_checkpoint_callback])
